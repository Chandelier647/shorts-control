...
import { createSettings, createUIObserver, isOnScreen } from '../../shared/index.js';
...
export const modifyYoutubeUI = () => {
    ...
    const enabled = youtubeSettings["youtube"];
